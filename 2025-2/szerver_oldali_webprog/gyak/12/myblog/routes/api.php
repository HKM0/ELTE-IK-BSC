...
/* A Route::patch('/posts/{post}/categories', [ApiController::class, 'updateCategories']); sor egy új API végpontot definiál, amely lehetővé teszi a kliensek számára, hogy frissítsék egy adott poszthoz kapcsolódó kategóriákat. Ez a végpont PATCH kéréseket fogad a /posts/{post}/categories URL-re, ahol a {post} helyőrző jelzi, hogy a kliensnek meg kell adnia egy poszt azonosítót a kérésben. Az updateCategories metódus fogja kezelni ezeket a kéréseket az ApiController-ben, és lehetővé teszi a kliensek számára, hogy módosítsák a poszthoz kapcsolódó kategóriákat, például új kategóriákat adjanak hozzá vagy meglévő kategóriákat távolítsanak el. */
