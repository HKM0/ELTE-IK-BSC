...
[**Forrás**](https://gkrisz.space/hu/course/kliensoldali/class/gyak-03)
## Bevezetés
...
- Shadow DOM-ot: `attachShadow({ mode: "open" })`, `this.shadowRoot.append()` – stílus-enkapszuláció
...
<div style="display: flex; justify-content: space-between;">
  <a href="02.md">← 2. gyakorlat - PWA: folyamatsáv és rendezhető táblázat</a>
