...
[**Forrás**](https://gkrisz.space/hu/course/kliensoldali/class/gyak-01)
## Bevezetés
...
Ez azt jelenti, hogy az `onScroll` függvény maximum 200 milliszekundumonként egyszer fut le, függetlenül attól, hogy a `scroll` esemény hányszor aktiválódik.
...
![viewport](img\viewport-image.D5Fw5ShW_G8nUd.webp)
...
#### 1. IntersectionObserver újrafelhasználása
...
<div style="display: flex; justify-content: space-between;">
  <a></a>
  <a href="05.md">2. gyakorlat - PWA: folyamatsáv és rendezhető táblázat →</a>
</div>