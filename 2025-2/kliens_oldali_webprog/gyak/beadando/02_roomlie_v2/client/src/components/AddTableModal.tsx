      ...
      <div className="bg-card text-card-foreground p-6 rounded-lg w-full max-w-[90%] shadow-lg" onClick={e => e.stopPropagation()}>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <select className="p-2 border border-border rounded focus:ring-ring outline-none bg-background text-foreground" name="color" value={formData.color} onChange={handleChange}>
